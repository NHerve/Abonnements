...
namespace Abonnements.Effects
{
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("Abonnements.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("Abonnements.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("Abonnements.PickerLineColorEffect")
            {
            }
        }
    }
